    ...
    rules: {
      "header/header": [
        ...
        [
          {
            // Matches either:
            // 1. Standard Apache license header: "Copyright YYYY Palantir..."
            // 2. Generated file header: "/* Generated by @palantir/pack... */"
            pattern:
              "( Generated by @palantir/pack\\.document-schema\\.type-gen@[\\d.]+ |(!\n)? Copyright \\d{4} Palantir Technologies, Inc\\. All rights reserved\\.)",
            template: "\n"
              + ` * Copyright ${
