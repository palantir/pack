...
/**
 * Detect which external ref types (ResourceRef, DocumentRef, MediaRef, ObjectRef,
...
/**
 * Detect the external ref type (resourceRef, docRef, mediaRef, objectRef, userRef) of a
 * field, if any.
 */
