...
export interface IFieldValueUnion_Array {
...
function isArray(obj: IFieldValueUnion): obj is IFieldValueUnion_Array {
  return (obj.type === "array");
}

function array(obj: IFieldTypeCollection): IFieldValueUnion_Array {
  return {
    array: obj,
    type: "array",
  };
