 ...
 *
 * The generic `S` is typically a generated `DocumentScope` union type from the
 * application's generated SDK, allowing consumers to narrow by version.
 *
 * @example
 * ```tsx
    ...
    const scope = useMemo(
      () =>
        ({
          ...
          ): void => docRef.withTransaction(fn, description),
        }) as unknown as S,
      [docRef, version],
    );
