# GitHub Copilot Instructions for PACK TypeScript Repository

## General Guidelines

This repository is a monorepo for the Palantir Platform Application Capabilities Kit (PACK) TypeScript packages. When working with this codebase, please follow these guidelines:
...
```yaml
---
"@palantir/pack.cli": patch
@palantir/pack.client: patch
---
```
