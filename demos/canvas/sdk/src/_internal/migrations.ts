...
export const ActivityEventMigrations: UnionMigrationRegistry<"ActivityEvent"> = {
...
export const NodeShapeMigrations: UnionMigrationRegistry<"NodeShape"> = {
  modelName: "NodeShape",
...
export const PresenceEventMigrations: UnionMigrationRegistry<"PresenceEvent"> = {
