...
import type { DocumentModel } from "./models.js";
import type { ActivityEventModel, ActivityShapeAddEventModel, ActivityShapeDeleteEventModel, ActivityShapeUpdateEventModel, NodeShapeModel, PresenceCursorEventModel, PresenceEventModel, PresenceSelectionEventModel, ShapeBoxModel, ShapeCircleModel } from "./models.js";
...
export function createVersionedDocRef(docRef: DocumentRef<DocumentModel>): VersionedDocRef {
  const version = getMetadata(docRef.schema).version as SupportedVersions;
  const ref = Object.create(docRef) as VersionedDocRef;
